        ...
        <div className="col-span-2">
          ...
          <section className="mb-12">
            ...
            <div className="p-6 rounded-lg bg-primary/5">
              ...
              <p className="mt-2 text-lg">University of Computer Science</p>
              <p className="mt-1 text-muted-foreground">2016 - 2020</p>
              <p className="mt-4">
                Studied computer science fundamentals, algorithms, data structures, web development, 
          ...
          <section>
            ...
            <ul className="space-y-4">
              <li className="p-4 rounded-lg bg-primary/5">
                <h3 className="font-semibold">Advanced React and Next.js</h3>
                <p className="mt-1 text-sm text-muted-foreground">Frontend Masters, 2022</p>
              </li>
              <li className="p-4 rounded-lg bg-primary/5">
                <h3 className="font-semibold">TypeScript for Professionals</h3>
                <p className="mt-1 text-sm text-muted-foreground">Udemy, 2021</p>
              </li>
            </ul>
          </section>
        </div>
